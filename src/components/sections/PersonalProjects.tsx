...
function getProjectImageSrc(
  ...
  if (project.imageSrcLight != null && project.imageSrcDark != null) {
    return isDark ? project.imageSrcDark : project.imageSrcLight;
  }
    ...
    <div id="personal-projects">
      ...
      <div className="space-y-6">
        {personalProjects.map((project) => {
          const src = getProjectImageSrc(project, isDark);
          if (!src) return null;
          return (
            <motion.div
              key={project.title}
