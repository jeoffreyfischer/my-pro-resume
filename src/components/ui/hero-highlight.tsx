...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        "relative inline-block rounded-lg bg-gradient-to-r from-indigo-300 to-purple-300 px-1 pb-1 text-indigo-950 dark:from-indigo-500 dark:to-purple-500 dark:text-white",
        className,
      )}
    >
      {children}
